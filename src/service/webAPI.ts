...
export class APIService
{
    ...
    public readonly USERS_UPDATE        = this.API_SERVER + 'UpdateUserData/';

    public readonly ARTIST_REGISTER     = this.API_SERVER + 'BecomeArtist/';
    ...
    public readonly ARTIST_UPDATE       = this.API_SERVER + 'UpdateArtistData/';
    ...
    public readonly ARTWORK_ADD         = this.API_SERVER + 'AddNewArtwork/';
    ...
    public readonly REQUEST_ADD         = this.API_SERVER + 'AddNewCommission/';
